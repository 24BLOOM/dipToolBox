...
from function.stackedWidget import StackedWidget
from function.treeView import FileSystemTreeView
from function.listWidgets import FuncListWidget, UsedListWidget
from function.graphicsView import GraphicsView
...
if __name__ == "__main__":
    ...
    app.setStyleSheet(open('./function/styleSheet.qss', encoding='utf-8').read())
    window = MyApp()
    window.show()
    sys.exit(app.exec_())
